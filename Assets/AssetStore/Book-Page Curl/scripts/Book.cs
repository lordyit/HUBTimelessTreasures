...
public class Book : MonoBehaviour {
    ...
    public void GoToPage(int page)
    {
        ...
        if (bookPages.Length - 1 < page) return;
        ...
        if(currentPage > page)
        {
            ...
            {
                DragLeftPageToPoint(new Vector3(2000, 0, 0));
                ReleasePage();
            }
        }
        else
        {
            ...
            for (int i = 0; i < diff/2; i++)
            {
                DragRightPageToPoint(new Vector3(-2000, 0, 0));
                ReleasePage();
            }
        }
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        else Left.color = new Color(0, 0, 0, 0);
        ...
        else Right.color = new Color(0, 0, 0, 0);

        if (currentPage < bookPages.Length - 2)
        {
            RightNext.sprite = bookPages[currentPage + 2];
            RightNext.color = new Color(1, 1, 1, 1);
            //CHANGE TO SET ACTIVE
        }
        else RightNext.color = new Color(0, 0, 0, 0);
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        if (currentPage >= 3)
        {
            ...
            LeftNext.color = new Color(1, 1, 1, 1);
        }
        else LeftNext.color = new Color(0, 0, 0, 0);
